...
public:
    ...
    void setupUi(QDialog *KeyboardDialog)
    {
        ...
        KeyboardDialog->resize(751, 525);
        m_block = new QLabel(KeyboardDialog);
        m_block->setObjectName(QString::fromUtf8("m_block"));
        m_block->setGeometry(QRect(290, 200, 50, 50));
        QPalette palette;
...
#endif
        m_block->setPalette(palette);
        m_block->setAutoFillBackground(true);
        m_block->setFrameShape(QFrame::WinPanel);
        m_block->setFrameShadow(QFrame::Raised);
    ...
    {
        KeyboardDialog->setWindowTitle(QApplication::translate("KeyboardDialog", "\351\224\256\347\233\230", nullptr));
        m_block->setText(QString());
    } // retranslateUi
